...
import com.daydreamapplications.adapter.layouts.line.ThreeLineLayouts
...
class ThreeLineListItemsActivity : AppCompatActivity() {
    ...
    private val viewModels: List<MaterialDesignListItem>
        get() = listOf(
            ThreeLineLayouts.none,
            ThreeLineLayouts.small,
            ThreeLineLayouts.medium,
            ThreeLineLayouts.large
        ).map(::SimpleListItem)
}