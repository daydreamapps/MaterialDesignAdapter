...
import com.daydreamapplications.materialdesignadapter.databinding.ActivityTextOnlyItemsBinding
...
class TextOnlyListItemsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ActivityTextOnlyItemsBinding.inflate(layoutInflater).apply {
            initRecyclerView(this)
            setContentView(root)
        }
    }

    private fun initRecyclerView(binding: ActivityTextOnlyItemsBinding) {
